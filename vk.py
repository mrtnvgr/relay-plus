...
class Vk:
    ...
    def method(self, method, params):
        ...
        params["v"] = "5.131"
        response = session.get(f"https://api.vk.com/method/{method}",
                            params=params).json()
    ...
    def checkPosts(self):
        ...
        for post in posts["items"]:
            ...
            if post["id"] not in history:
                ...
                pass # self.master.config.addHistory(post["id"])
                    ...
                    if link["description"] == "Плейлист":
                        ...
                        if "items" in audios:
                            ...
                            for audio in audios["items"]:
                                ...
                                self.master.log.info(f"         Music: {audio['title']}")
